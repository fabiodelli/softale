...
export default function HomeClient({ initialStories, initialCollections }: HomeClientProps) {
    ...
    return (
        ...
        >
            ...
            <div
                className="relative z-10 mt-[30vh] md:mt-[70vh] bg-slate-50/60 backdrop-blur-2xl min-h-screen pb-20 md:pb-12 shadow-none transition-all duration-75 ease-out"
                style={{
