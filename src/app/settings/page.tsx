...
import { ChevronLeft, ChevronRight, Mail, Info, FileText, Shield, CreditCard, Lock, LogOut } from 'lucide-react';
...
export default function SettingsPage() {
    ...
    const { user, profile, isPremium, signOut, loading: authLoading } = useAuth();
        ...
        <GlassLayout variant="functional">
            <div className="max-w-xl mx-auto px-4 pt-20 pb-32">
                ...
                <div className="space-y-8">
                    {/* Profile Section */}
                    <section className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm">
                        ...
                        {isEditing ? (
                            ...
                            <div onClick={() => setIsEditing(true)} className="flex items-center gap-4 p-4 rounded-xl border border-slate-200 hover:border-indigo-200 hover:bg-white/50 transition cursor-pointer group">
                                <div className="w-14 h-14 rounded-full bg-white border border-slate-100 flex items-center justify-center text-3xl shadow-sm">
                                    {profile?.avatar_url && profile.avatar_url.startsWith('http') ? (
                                        <img src={profile.avatar_url} className="w-full h-full object-cover rounded-full" alt="User" />
                                    ) : (
                                        profile?.avatar_url || '👤'
                                    )}
                                </div>
                    ...
                    <section className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm">
                        ...
                        {isPremium ? (
                            <button
                                ...
                                className="w-full flex items-center justify-between p-4 bg-indigo-50 rounded-xl border border-indigo-100 hover:bg-indigo-100 transition group"
                            >
                            ...
                            <Link href="/upgrade" className="flex items-center justify-between p-4 bg-amber-50 rounded-xl border border-amber-100 hover:bg-amber-100 transition group">
                                <div className="flex items-center gap-3">
                    ...
                    <section className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm">
                        ...
                        <div className="space-y-2">
                            <Link href="/vision" className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-white/50 transition text-slate-600">
                            ...
                            <Link href="/privacy" className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-white/50 transition text-slate-600">
                            ...
                            <Link href="/terms" className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-white/50 transition text-slate-600">
                            ...
                            <Link href="/cookie" className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-white/50 transition text-slate-600">
                    ...
                    <section className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm">
                        ...
                        <div className="space-y-2">
                            <button
                                ...
                                className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-white/50 transition text-slate-600 disabled:opacity-70 disabled:cursor-not-allowed"
                            >
                            ...
                            <a href="mailto:support@softale.app" className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-white/50 transition text-slate-600">
                            ...
                            }} className="w-full flex items-center gap-3 p-3 rounded-xl hover:bg-white/50 transition text-slate-500 group">
                    ...
                    {/* Social Links */}
                    <section className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/40 shadow-sm">
                        <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">Follow Us</h3>
                        <div className="flex justify-center items-center gap-4">
                            <a href="https://instagram.com/softale.app" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-slate-50 text-slate-400 hover:text-pink-500 hover:bg-pink-50 transition-colors" aria-label="Instagram">
                            ...
                            <a href="https://tiktok.com/@softale.app" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-slate-50 text-slate-400 hover:text-slate-900 hover:bg-slate-100 transition-colors" aria-label="TikTok">
                            ...
                            <a href="https://twitter.com/softaleapp" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-slate-50 text-slate-400 hover:text-sky-500 hover:bg-sky-50 transition-colors" aria-label="Twitter">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                            </a>
                            <a href="https://youtube.com/@softaleapp" target="_blank" rel="noopener noreferrer" className="p-3 rounded-xl bg-slate-50 text-slate-400 hover:text-red-500 hover:bg-red-50 transition-colors" aria-label="YouTube">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 p-4 rounded-2xl bg-red-50 text-red-600 hover:bg-red-100 font-bold transition border border-red-100 hover:border-red-200"
                    >
